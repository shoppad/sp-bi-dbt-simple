...
WITH
decorated_shops AS (
{% set columns_to_skip = ['_id', 'group', 'scopes', 'billing', 'status', 'entitlements', 'uuid', 'timestamp', 'shopify', 'usage', 'config', 'themes', 'webhooks', 'messages', 'analytics', '_created_at', 'schema', 'handle', 'method', 'account', 'wizard', 'mongoid', 'authtoken', 'metabase'] %}
    SELECT

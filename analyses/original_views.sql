...
{# CREATE OR REPLACE VIEW mongo.public.m3_mesa_billing_vw AS
    SELECT
        ...
        billing:"plan"."automation"."limit_percent"::FLOAT as plan_percent_used,
        to_timestamp(IFNULL(billing:"plan"."start"::INT, billing:"plan_start"::INT), 3) as plan_start,
        billing:"plan"."automation"."status"::STRING as plan_status,
        billing:"plan"."automation"."count"::FLOAT as plan_used,
